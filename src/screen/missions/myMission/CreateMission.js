  ...
  return (
    <Card style={{ width: '90%', marginLeft: 'auto', marginRight: 'auto', marginTop: 90, marginBottom: '2%' }}>
      ...
      <form className='form' onSubmit={postCreateMission}>
        ...
        <Field onChange={handleChangeRadio('has_text')} name="has_text" component={RadioButtonTypeSent} checked={values.has_text} label="Texto" />
        <Field onChange={handleChangeRadio('has_image')} name="has_image" component={RadioButtonTypeSent} checked={values.has_image} label="Imagem" />
